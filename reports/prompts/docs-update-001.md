# Task: Update developer documentation after an agent workflow change

Type: documentation
Objective: Generate a concise documentation patch from code and workflow changes.
